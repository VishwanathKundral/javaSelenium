...
public class WebDriverBase {
    ...
    public static void getWebDriver(String browser) {
        ...
        if(browser.equals("chrome")) {
            ...
            InOutLibrary.writeLine("Launching Chrome Browser.");
            ...
            InOutLibrary.writeLine("Launching Firefox Browser.");
            driver = new FirefoxDriver();
            driver.manage().window().maximize();

        } else if(browser.equals("seleniumGrid")) {
            InOutLibrary.writeLine("Launching Browser Using Selenium Grid - Chrome Browser.");
